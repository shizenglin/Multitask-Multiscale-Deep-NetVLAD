function [net,stats] = crowd_cnn_train_dag(net, getBatch, varargin)
...
if isempty(opts.train), opts.train = 1:opts.dataSize ; end
...
if strcmp(mode,'train')
  state.momentum = num2cell(ones(1, numel(net.params))) ;
end
